...
# Specific constraint for slot 3 - limit the total number of papers to 66
slot_3_clauses = [var_map[(session, 3, papers)] for session in conference_sessions for papers in papers_range]
cnf.append(slot_3_clauses[:66])
